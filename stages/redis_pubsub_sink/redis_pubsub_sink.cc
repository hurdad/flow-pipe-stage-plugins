...
using RedisPubSubSinkConfig =
    flowpipe::stages::redis::pubsub::sink::v1::RedisPubSubSinkConfig;

// ============================================================
// RedisPubSubSink
// ============================================================
class RedisPubSubSink final
    : public ISinkStage,
...
public:
  ...
  bool Configure(const google::protobuf::Struct& config) override {
    ...
    if (!status.ok()) {
      FP_LOG_ERROR("redis_pubsub_sink failed to serialize config");
      return false;
    }
    ...
    if (!status.ok()) {
      FP_LOG_ERROR("redis_pubsub_sink invalid config");
      return false;
    }
