...
find_package(AWSSDK QUIET COMPONENTS core s3 sns sqs)
...
if(NOT AWSSDK_FOUND)
  ...
  if(TARGET aws-cpp-sdk-sns AND NOT TARGET AWS::sns)
    add_library(AWS::sns ALIAS aws-cpp-sdk-sns)
  endif()
  if(TARGET aws-cpp-sdk-sqs AND NOT TARGET AWS::sqs)
    add_library(AWS::sqs ALIAS aws-cpp-sdk-sqs)
  endif()
endif()
...
if(NOT TARGET AWS::sns)
  message(FATAL_ERROR "AWS SDK sns target is not available. Install the AWS SDK for C++ or enable the FetchContent fallback.")
endif()
if(NOT TARGET AWS::sqs)
  message(FATAL_ERROR "AWS SDK sqs target is not available. Install the AWS SDK for C++ or enable the FetchContent fallback.")
endif()
